  ...
  <div class="flex items-center justify-center min-h-screen bg-gray-100">
    <div class="bg-white p-6 rounded shadow-lg w-96">
      ...
      <form @submit.prevent="handleLogin">
        ...
        <button type="submit" class="w-full py-2 bg-gray-400 text-black hover:bg-gradient-to-l hover:from-slate-300 hover:to-slate-500 font-bold rounded hover:bg-blue-600">
          Login
        </button>
      </form>
    </div>
